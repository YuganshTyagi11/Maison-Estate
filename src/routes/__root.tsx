...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A private global brokerage representing the world's most distinguished residences. Discretion, expertise, and a global reach since 1987." },
      { property: "og:title", content: "Maison Estate — Distinguished Residences" },
      { property: "og:description", content: "Private brokerage representing the world's most distinguished residences." },
